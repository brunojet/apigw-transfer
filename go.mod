module github.com/brunojet/apigw-transfer
...
require (
	...
	github.com/brunojet/go-infra-adapters/v4 v4.3.0
)
...
replace github.com/brunojet/go-infra-adapters/v4 => ../go/go-infra-adapters
